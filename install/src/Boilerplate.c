/* Boilerplate.c generated by valac 0.34.4, the Vala compiler
...
static void boilerplate_boilerplate_real_activate (GApplication* base) {
	...
	g_debug ("Boilerplate.vala:62: %s", BOILERPLATE_app_id);
	_tmp6_ = self->priv->settings;
	_tmp7_ = g_settings_get_string (_tmp6_, "foo");
	_tmp8_ = _tmp7_;
	g_debug ("Boilerplate.vala:63: %s", _tmp8_);
	_g_free0 (_tmp8_);
	_tmp9_ = _ ("Hello, world");
	g_debug ("Boilerplate.vala:64: %s", _tmp9_);
}
